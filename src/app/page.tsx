...
// Prices are read from the canonical catalog so this page can never drift.
const services = [
  { label: "MAIL", title: "A real inbox", provider: "Resend", price: EMAIL_SERVICES.createMailbox.amount, detail: "Provision, send, receive, retrieve." },
  { label: "VOICE", title: "A live number", provider: "AgentPhone", price: `${PHONE_SERVICES.purchaseUsNumber30Days.amount} / 30d`, detail: "Inbound and outbound conversations controlled by the agent over WebSocket." },
