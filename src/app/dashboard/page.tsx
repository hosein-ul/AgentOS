      ...
      {!session.tenantId ? (
        <Card className="border-accent/30 bg-accent-soft p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button asChild><Link href="/dashboard/mailboxes">Create mailbox · {EMAIL_SERVICES.createMailbox.amount} USDT</Link></Button>
            <Button variant="secondary" asChild><Link href="/dashboard/numbers">Buy phone number · {PHONE_SERVICES.purchaseUsNumber30Days.amount} USDT</Link></Button>
          </div>
        </Card>
      ) : null}
